...
import './bed.scss'
let wsPointData = []
let collection = JSON.parse(localStorage.getItem('collection')) ? JSON.parse(localStorage.getItem('collection')) : [['数据','睡姿','性别','姓名','体重','城市','年龄','身高','其他','健康状况','基础病史','联系方式']]
let csvData
...
class Anta extends React.Component {
  message(e) {
    ...
    if (jsonObject.data != null) {
      ...
      if (wsPointData[wsPointData.length - 1] == 1) {
  ...
  download() {
    message.info('删除成功')
    collection = [['数据','睡姿','性别','姓名','体重','城市','年龄','身高','其他','健康状况','基础病史','联系方式']]
      ...
      <>
        ...
        <div style={{width: '100%', height: '100vh', overflow: 'hidden', position: 'relative'}}>
          ...
          <div className="content col">
            ...
            <div style={{marginBottom: '10px' ,marginTop : '32%'}}>
              <input
                type="text"
                style={{width: 140, marginRight: 10}}
                placeholder="姓名"
